...
/** @var app\models\dictionaries\DicTaskStatus $model */
$this->title = $model->isNewRecord ? 'Добавить статус заявки' : 'Редактировать статус заявки';
$this->params['breadcrumbs'][] = ['label' => 'Справочники', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Статусы заявок', 'url' => ['task-status']];
$this->params['breadcrumbs'][] = $model->isNewRecord ? 'Добавить' : 'Редактировать';
?>
<div class="references-task-status-form">
    ...
    <div class="form-group">
        ...
        <?= Html::a('Отмена', ['task-status'], ['class' => 'btn btn-secondary']) ?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
