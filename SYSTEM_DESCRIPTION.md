...
По модели данных (см. `docs/МОДЕЛЬ_БД_ias_vniic.md`, `docs/ОСНОВНОЙ_УЧЕТ_И_БД.md`) рассматриваются сущности:
...
- документация по архитектуре, БД, плану реализации и требованиям (TZ.md, `docs/МОДЕЛЬ_БД_ias_vniic.md`, ПЛАН_РЕАЛИЗАЦИИ.md, docs/**).
