...
**Источники:** `TZ.md`, `scripts/create_ias_vniic.sql`, `docs/МОДЕЛЬ_БД_ias_vniic.md`.
...
- После добавления software, licenses, software_installs и task_comments внести их в описание модели и ER-диаграмму в `docs/МОДЕЛЬ_БД_ias_vniic.md`.
...
| 1.5 | Обновить **docs/МОДЕЛЬ_БД_ias_vniic.md**: новые таблицы, связи, ER. | Актуальная документация. |
